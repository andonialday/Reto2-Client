...
public class EquipmentJerseyClient {
    ...
    private static final String BASE_URI = "http://localhost:25559/Reto2G1cServer/webresources";
    ...
    public <T> T findOrderAfterDate(Class<T> responseType, String dateAfter) throws ClientErrorException {
    ...
    public <T> T findOrderPreviousDate(Class<T> responseType, String datePrev) throws ClientErrorException {
        WebTarget resource = webTarget;
    ...
    public <T> T findCostRange(Class<T> responseType, String min, String max) throws ClientErrorException {
        WebTarget resource = webTarget;
    ...
    public <T> T deleteOldEquip(Class<T> responseType, String year) throws ClientErrorException {
        WebTarget resource = webTarget;
