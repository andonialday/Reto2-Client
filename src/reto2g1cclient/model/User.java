...
public class User implements Serializable {
     ...
     * @param signIns 
     */
    public User(Integer id, String login, String email, String fullName, UserStatus status, Privilege privilege, String password, Date lastPasswordChange, Set<SignIn> signIns) {
        this.id = id;
        this.login = login;
        this.email = email;
