...
public class VSignInControllerIT extends ApplicationTest {
    ...
    private Hyperlink hyperSignUp, hyperReset;
    ...
    /**
     * Test of initial stage of login view. SignIn button disabled, Exit button
     * and hyperlink SignUp enabled.
     */
    @Test
    ...
    /**
     * Test that the SignIn button is disabled if the username or password
     * fields are empty and enabled if username and password are complete.
     *
    ...
    /**
     * Test that if the username and password are not correct, do not enter the
     * welcome window and an alert panel appears.
     *
     * @throws java.lang.InterruptedException
     */
    @Ignore
    ...
    /**
     * We press the Exit button and a confirmation panel will appear. If we
     * press the Cancel button we return to the previous window.
     *
     * @throws java.lang.InterruptedException
     */
    @Test
     ...
     * If we press the Back button in the Sign Up window, we return to the Sing
     * In window with the username and password fields empty.
     *
     * @throws java.lang.InterruptedException
     */
    @Test
    ...
    /**
     * Test that if the username and password are correct, enter the Welcome
     * window. If we click the Close Session hyperlink button in the Final
     * window, we return to the Sign In window with empty fields.
     *
     * @throws java.lang.InterruptedException
     */
    @Ignore
    ...
    @Ignore
    @Test
    public void test07_hyperSignUp() {
        clickOn("#hyperSignUp");
        verifyThat("#pSignIn", isInvisible());
    }

    @Ignore
    @Test
    public void test08_resetPass() {
        clickOn("#hyperReset");
        verifyThat("#pSignIn", isInvisible());
    }
